...
function CrearNavBar()
{
    ...
    <div class="mx-auto d-sm-flex d-block flex-sm-nowrap">
      ...
      <div class="collapse navbar-collapse text-center" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="https://UristotelesCEP.github.io">Inicio</a>
          </li>
          
          
          <li class="nav-item">
            <a class="nav-link active" href="https://UristotelesCEP.github.io/Exemples/" tabindex="-1" aria-disabled="true">MiniProgramas</a>
          </li>
          <li class="nav-item">
